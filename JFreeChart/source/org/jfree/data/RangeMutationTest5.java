...
public class RangeMutationTest5 extends TestCase {
	...
	public static Range expandToInclude(Range range, double value) {
	    if (range == null) {
	        return new Range(0, 0); // Replacement by 0
	    }
	    if (value < range.getLowerBound()) {
	        return new Range(0, range.getUpperBound()); // Replacement by 0
	    }
	    else if (value > range.getUpperBound()) {
	        return new Range(range.getLowerBound(), 0); // Replacement by 0
	    }
	    else {
	        return range;
	    }
