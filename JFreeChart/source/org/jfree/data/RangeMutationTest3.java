...
public class RangeMutationTest3 extends TestCase {
	...
	public static Range expandToInclude(Range range, double value) {
	    if (range == null) {
	    	return new Range(range.getUpperBound(), range.getLowerBound()); //Return Statement Replacement
	    }
	    if (value < range.getLowerBound()) {
	    	return new Range(range.getUpperBound(), value); //Return Statement Replacement
	    }
	    else if (value > range.getUpperBound()) {
	    	return new Range(value, range.getLowerBound()); //Return Statement Replacement
	    }
	    else {
	        return range;
	    }
